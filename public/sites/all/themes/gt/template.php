...
// Adding Bootstrap 4 CSS via CDN
    drupal_add_css('https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css', 'external');

// Adding Adobe Typekit fonts
    drupal_add_css('https://use.typekit.net/ela2mmm.css?family=Din:400,400italic,600,600italic,700,700italic', 'external');

// Adding Bootstrap JS via CDN
    drupal_add_js('https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.min.js', array('type' => 'external', 'scope' => 'header'));
    drupal_add_js('https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js', array('type' => 'external', 'scope' => 'header'));
...
// Site title and site title class variables
    ...
    if ($site_title_line_1 != '') {
        if ($site_title_line_2 != '') {
            ...
            $variables['site_title'] = '<h2 class="site-name">' . $site_title_line_1 .'</h2>' . '<h3 class="site-slogan">' . $site_title_line_2 .'</h3>';
        }
        else {
